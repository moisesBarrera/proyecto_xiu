...
public class MainActivity extends AppCompatActivity {
    public static String ip="192.168.43.231:5000";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new ConsultarDatos().execute("http://192.168.43.231:5000/login?usuario=" + usuario.getText().toString().trim()+"&contrasena="+contraseña.getText().toString().trim()+"");
                System.out.println("http://192.168.43.231:5000/login?usuario=" + usuario.getText().toString().trim()+"&contrasena="+contraseña.getText().toString().trim()+"");
            }});
