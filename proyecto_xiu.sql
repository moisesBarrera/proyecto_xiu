...
DELIMITER $$
USE `SGG`$$
CREATE PROCEDURE `nueva_tarea` (IN Nombre VARCHAR(255),IN Grupo_idgrupo INT(11))
BEGIN
	INSERT INTO tarea (nombre,grupo_idgrupo) VALUES (Nombre, Grupo_idgrupo); 
