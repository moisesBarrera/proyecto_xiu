...
DELIMITER $$
USE `SGG`$$
CREATE PROCEDURE `new_Student` (IN Nombre VARCHAR(255), IN Apellido VARCHAR(255), IN Genero VARCHAR(45), IN Curp VARCHAR(45), IN Matricula VARCHAR(45), IN Usuario_idusuario INT(11), IN Observaciones VARCHAR(255),IN Grupo_idgrupo INT(11), IN idPadre INT(11))
BEGIN
	DECLARE `ID` INT DEFAULT 0;
    ...
    INSERT INTO Alumnos_has_PadresFamilia (Alumnos_idAlumnos, PadresFamilia_idPadresFamilia) VALUES (`ID`,idPadre);
END$$
